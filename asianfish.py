...
DORSAL_FIN_COLOR_BOSS3 = CYAN
DORSAL_FIN_COLOR_BOSS4 = ORANGE
DORSAL_FIN_COLOR_BOSS5 = PURPLE

# Dorsal fin size definitions
DORSAL_FIN_WIDTH_BOSS3 = BOSS3_SIZE // 2
DORSAL_FIN_WIDTH_BOSS4 = BOSS4_SIZE // 2
DORSAL_FIN_WIDTH_BOSS5 = BOSS5_SIZE // 2

DORSAL_FIN_HEIGHT_BOSS3 = 40
DORSAL_FIN_HEIGHT_BOSS4 = 60
DORSAL_FIN_HEIGHT_BOSS5 = 80

def draw_dorsal_fin(x, y, enemy_width, enemy_height, enemy_type):
    if enemy_type in ['boss3', 'boss4', 'boss5']:
        if enemy_type == 'boss3':
            fin_height = DORSAL_FIN_HEIGHT_BOSS3
            fin_width = DORSAL_FIN_WIDTH_BOSS3
            fin_color = DORSAL_FIN_COLOR_BOSS3
        elif enemy_type == 'boss4':
            fin_height = DORSAL_FIN_HEIGHT_BOSS4
            fin_width = DORSAL_FIN_WIDTH_BOSS4
            fin_color = DORSAL_FIN_COLOR_BOSS4
        elif enemy_type == 'boss5':
            fin_height = DORSAL_FIN_HEIGHT_BOSS5
            fin_width = DORSAL_FIN_WIDTH_BOSS5
            fin_color = DORSAL_FIN_COLOR_BOSS5

        # The key change: Move the fin's base up by the fin's height to put it on top of the fish
        # fin_y adjusted to move the fin up so it starts at 'y - fin_height' instead of 'y'
        fin_x = x + enemy_width / 2 - fin_width / 2
        fin_y = y - fin_height  # Move the dorsal fin above the oval

        # Adjusting points for the right triangle
        point1 = (fin_x, fin_y + fin_height)  # Base of the fin adjusted to start at the top of the fish
        point2 = (fin_x + fin_width, fin_y + fin_height)  # Same adjustment for the other base point
        point3 = (fin_x + fin_width / 2, fin_y)  # The tip of the fin is correctly positioned above the fish

        # Drawing the dorsal fin triangle
