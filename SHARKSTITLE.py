...
def update_display(game_state):
    if game_state == "start":
        ...
        # Proceed with rendering elements related to the "game" state as before
        # Your original game rendering code here unaltered from what you had provided earlier
        
        # For the sake of completeness, I'll focus on the modifications for displaying the title with an outline in the "start" state.
        # Refer to your existing 'elif game_state == "game":' section code for rendering objects in the game state.
